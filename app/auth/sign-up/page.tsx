...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FDF8F5] via-white to-[#F5F0EC] px-4 py-8">
      {/* Background decorative elements */}
      <div className="fixed top-20 left-10 w-72 h-72 bg-[#8B1E3F]/5 rounded-full blur-3xl" />
      <div className="fixed bottom-20 right-10 w-96 h-96 bg-[#D4A574]/5 rounded-3xl blur-3xl" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-[#8B1E3F] to-[#D4A574] bg-clip-text text-transparent mb-2">
            Создать аккаунт
          </h1>
          <p className="text-[#6B7280] text-center">
            Присоединяйтесь к Flame уже сегодня
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/50">
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-[#8B1E3F] to-[#D4A574] text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-[#6B7280]">
              Уже есть аккаунт?{' '}
              <Link href="/auth/login" className="text-[#8B1E3F] font-semibold hover:text-[#D4A574] transition-colors">
                Войти
              </Link>
            </p>
          </div>
